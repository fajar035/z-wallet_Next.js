      ...
      <main className="container-fluid p-0">
        ...
        <section className="row mb-5">
          <div className={`col-lg-12 ${styles["wrapper-img-platform"]} `}>
            ...
            <Image src={airbnb} alt="logo-microsoft" width={150} height={100} />
            <Image src={canon} alt="logo-microsoft" width={150} height={100} />
            <Image src={dell} alt="logo-microsoft" width={150} height={100} />
          </div>
          <div className="col-lg-12">
            <h1 className={`${styles["title-about"]}`}>
              <span className={`${styles.about}`}>About</span> the Application.
            </h1>
            ...
            <div className={`${styles["wrapper-card-about"]}`}>
              <div className={` ${styles["card"]}`}>
                <Image src={phone} alt="logo-phone" width={100} height={100} />
        ...
        <section className="row mb-lg-5">
          <div className="col-lg-12">
            ...
            <div className={`mb-lg-5 ${styles["wrapper-description-about"]}`}>
              <p className={`${styles["description-about"]}`}>
                We have some great features from the application and it’s
                totally free to use by all users around the world.
              </p>
